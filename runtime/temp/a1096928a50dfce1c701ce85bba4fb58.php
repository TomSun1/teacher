                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control" name="subject_id">
                                                            ...
                                                            <option value="<?php echo $vo['subject_id']; ?>" <?php if($chapter->subject_id == $vo['subject_id']): ?>   selected="selected" <?php endif; ?></option><?php echo $vo['subject_name']; ?></option>
