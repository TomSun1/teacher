<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:75:"/Library/WebServer/Documents/dqExam/application/admin/view/subject/add.html";i:1509677872;s:70:"/Library/WebServer/Documents/dqExam/application/admin/view/header.html";i:1507863360;s:67:"/Library/WebServer/Documents/dqExam/application/admin/view/nav.html";i:1507863360;s:68:"/Library/WebServer/Documents/dqExam/application/admin/view/menu.html";i:1507863360;s:70:"/Library/WebServer/Documents/dqExam/application/admin/view/footer.html";i:1507863360;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box box-danger">
                                ...
                                <div class="box-body">
                                    <form method="POST" name="form" id="form" action="<?php echo url('admin/subject/add'); ?>">
                                        ...
                                        <div class="form-group">
                                            <label>科目类型值(必填)</label>
                                            <div class="input-group">
                                                <input type="text" class="form-control" name="software_type_value"/>
                                            </div><!-- /.input group -->
                                        </div><!-- /.form group -->
                                        <div class="form-group">
                                            <label>是否显示</label>
