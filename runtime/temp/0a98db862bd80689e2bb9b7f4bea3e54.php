<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:65:"D:\Program\www\dqExam./application/admin\view\auth\editrules.html";i:1492919725;s:57:"D:\Program\www\dqExam./application/admin\view\header.html";i:1492841155;s:54:"D:\Program\www\dqExam./application/admin\view\nav.html";i:1491550433;s:55:"D:\Program\www\dqExam./application/admin\view\menu.html";i:1492911380;s:57:"D:\Program\www\dqExam./application/admin\view\footer.html";i:1492841175;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
        <title>题库管理系统 | 添加用户组</title>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo url('admin/auth/auth'); ?>"><i class="fa fa-group"></i> 权限</a></li>
                        ...
                        <div class="col-md-12">
                            <div class="box box-danger">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <form action="<?php echo url('admin/auth/editRules'); ?>" method="POST" name="form" id="form">
                                                ...
                                                <div class="form-group">
                                                    <label>标题</label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="title" value="<?php echo $rule['title']; ?>">
                                                    </div><!-- /.input group -->
                                                </div><!-- /.form group -->
                                                <div class="form-group">
                                                    <label>条件</label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control" name="condition" value="<?php echo $rule['condition']; ?>">
                                                    </div><!-- /.input group -->
                                                </div><!-- /.form group -->
                                                <div class="form-group">
                                                    <label>是否启用</label>
