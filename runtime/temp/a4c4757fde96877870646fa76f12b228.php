                                ...
                                <div class="box-body">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tr id="node-<?php echo $vo['subject_id']; ?>">
                                            <td><?php echo $vo['html']; ?><?php echo $vo['subject_name']; ?></td>
                                            <td><?php echo $vo['subject_description']; ?></td>
                                            <td>
                                                <a href="<?php echo url('admin/subject/edit','id='.$vo['subject_id']); ?>" class="btn btn-primary">
                                                    <i class="glyphicon glyphicon-pencil"></i>  编辑
                                                </a>
                                                <a href="javascript:;" onclick="deleteConfirm(<?php echo $vo['subject_id']; ?>)" class="btn btn-danger">
