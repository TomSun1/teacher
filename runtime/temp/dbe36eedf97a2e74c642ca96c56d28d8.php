                                ...
                                <div class="box-body">
                                    ...
                                    <table class="table table-hover">
                                        <tbody>
                                            ...
                                            <tr id="node-<?php echo $vo['QUESTION_ID']; ?>">
                                                ...
                                                <td>
                                                    <a href="javascript:;" onclick="deleteConfirm(<?php echo $vo['QUESTION_ID']; ?>);">删除</a>
                                                    <a href="<?php echo url('admin/exercises/edittype','qid='.$vo['QUESTION_ID'].'&sid='.$sid); ?>">编辑</a>
                                                </td>
                                            </tr>
